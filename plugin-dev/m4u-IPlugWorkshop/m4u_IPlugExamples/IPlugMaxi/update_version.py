...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugMaxi-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugMaxi-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugMaxi-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugMaxi-OSXAPP-Info.plist"
...
#   plistpath = scriptpath + "/resources/IPlugMaxi-IOSAPP-Info.plist"
...
#   plistlib.writePlist(iosapp, plistpath)
  ...
  plistpath = scriptpath + "/installer/IPlugMaxi.packproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugMaxi.iss",inplace=1):
