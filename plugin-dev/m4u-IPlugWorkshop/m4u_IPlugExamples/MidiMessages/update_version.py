...
def main():
  ...
  plistpath = scriptpath + "/resources/MidiMessages-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MidiMessages-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MidiMessages-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MidiMessages-OSXAPP-Info.plist"
...
#   plistpath = scriptpath + "/resources/MidiMessages-IOSAPP-Info.plist"
...
#   plistlib.writePlist(iosapp, plistpath)
  ...
  plistpath = scriptpath + "/installer/MidiMessages.packproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/MidiMessages.iss",inplace=1):
