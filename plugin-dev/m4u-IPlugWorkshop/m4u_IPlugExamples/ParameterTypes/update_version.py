...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright OliLarkin, 2011"
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/ParameterTypes-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ParameterTypes-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ParameterTypes-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ParameterTypes-OSXAPP-Info.plist"
...
#   plistpath = scriptpath + "/resources/ParameterTypes-IOSAPP-Info.plist"
...
#   plistlib.writePlist(iosapp, plistpath)
  ...
  plistpath = scriptpath + "/installer/ParameterTypes.packproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/ParameterTypes.iss",inplace=1):
