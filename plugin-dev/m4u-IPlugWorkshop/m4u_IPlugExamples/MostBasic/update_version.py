...
def main():
  ...
  plistpath = scriptpath + "/resources/MostBasic-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MostBasic-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MostBasic-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MostBasic-OSXAPP-Info.plist"
...
#   plistpath = scriptpath + "/resources/MostBasic-IOSAPP-Info.plist"
...
#   plistlib.writePlist(iosapp, plistpath)
  ...
  plistpath = scriptpath + "/installer/MostBasic.packproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/MostBasic.iss",inplace=1):
