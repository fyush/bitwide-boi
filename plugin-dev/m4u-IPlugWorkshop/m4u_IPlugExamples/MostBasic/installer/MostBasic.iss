...
AppName=MostBasic
AppVersion=1.0.0
DefaultDirName={pf}\MostBasic
DefaultGroupName=MostBasic
Compression=lzma2
SolidCompression=yes
OutputDir=.\
ArchitecturesInstallIn64BitMode=x64
OutputBaseFilename=MostBasic Installer
...
[Files]
Source: "..\build-win-app\Win32\bin\MostBasic.exe"; DestDir: "{app}"; Check: not Is64BitInstallMode; Components:app;
Source: "..\build-win-app\x64\bin\MostBasic.exe"; DestDir: "{app}"; Check: Is64BitInstallMode; Components:app;

Source: "..\build-win-vst2\Win32\bin\MostBasic.dll"; DestDir: {code:GetVST2Dir_32}; Check: not Is64BitInstallMode; Components:vst2_32;
Source: "..\build-win-vst2\Win32\bin\MostBasic.dll"; DestDir: {code:GetVST2Dir_32}; Check: Is64BitInstallMode; Components:vst2_32;
Source: "..\build-win-vst2\x64\bin\MostBasic.dll"; DestDir: {code:GetVST2Dir_64}; Check: Is64BitInstallMode; Components:vst2_64;

Source: "..\build-win-vst3\Win32\bin\MostBasic.vst3"; DestDir: "{cf}\VST3\"; Check: not Is64BitInstallMode; Components:vst3_32;
Source: "..\build-win-vst3\Win32\bin\MostBasic.vst3"; DestDir: "{cf32}\VST3\"; Check: Is64BitInstallMode; Components:vst3_32;
Source: "..\build-win-vst3\x64\bin\MostBasic.vst3"; DestDir: "{cf64}\VST3\"; Check: Is64BitInstallMode; Components:vst3_64;

Source: "..\build-win-rtas\bin\MostBasic.dpm"; DestDir: "{cf32}\Digidesign\DAE\Plug-Ins\"; Components:rtas_32;
Source: "..\build-win-rtas\bin\MostBasic.dpm.rsr"; DestDir: "{cf32}\Digidesign\DAE\Plug-Ins\"; Components:rtas_32;

Source: "..\manual\MostBasic_manual.pdf"; DestDir: "{app}"
Source: "changelog.txt"; DestDir: "{app}"
Source: "readmewin.rtf"; DestDir: "{app}"; DestName: "readme.rtf"; Flags: isreadme

[Icons]
Name: "{group}\MostBasic"; Filename: "{app}\MostBasic.exe"
Name: "{group}\User guide"; Filename: "{app}\MostBasic_manual.pdf"
Name: "{group}\Changelog"; Filename: "{app}\changelog.txt"
;Name: "{group}\readme"; Filename: "{app}\readme.rtf"
Name: "{group}\Uninstall MostBasic"; Filename: "{app}\unins000.exe"
