...
def main():
  ...
  plistpath = scriptpath + "/resources/IPlugGamma-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugGamma-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugGamma-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/IPlugGamma-OSXAPP-Info.plist"
...
#   plistpath = scriptpath + "/resources/IPlugGamma-IOSAPP-Info.plist"
...
#   plistlib.writePlist(iosapp, plistpath)
  ...
  plistpath = scriptpath + "/installer/IPlugGamma.packproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/IPlugGamma.iss",inplace=1):
