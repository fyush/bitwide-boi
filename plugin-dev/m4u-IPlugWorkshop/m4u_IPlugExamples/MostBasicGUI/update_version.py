...
def main():
  ...
  plistpath = scriptpath + "/resources/MostBasicGUI-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MostBasicGUI-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MostBasicGUI-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MostBasicGUI-OSXAPP-Info.plist"
...
#   plistpath = scriptpath + "/resources/MostBasicGUI-IOSAPP-Info.plist"
...
#   plistlib.writePlist(iosapp, plistpath)
  ...
  plistpath = scriptpath + "/installer/MostBasicGUI.packproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/MostBasicGUI.iss",inplace=1):
